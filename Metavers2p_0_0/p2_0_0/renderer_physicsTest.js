...
const GolpexColumnDOMRect = GolpexElement.parentElement.getBoundingClientRect();
const GolpexRowDOMRect = GolpexElement.parentElement.parentElement.getBoundingClientRect();
const RATIO = 3/5//GolpexColumnDOMRect.width / GolpexRowDOMRect.width

import * as THREE from 'three';
			import { OrbitControls } from 'three/addons/controls/OrbitControls.js';
			import { AmmoPhysics } from 'three/addons/physics/AmmoPhysics.js';
			//https://github.com/mrdoob/three.js/blob/dev/examples/jsm/physics/AmmoPhysics.js
			...
			async function init() {
				...
				physics.addMesh( boxes, 20*Math.random() );
